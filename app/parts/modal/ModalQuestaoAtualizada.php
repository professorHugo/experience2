<?php
if(isset($_POST['atualizarRespostaVerdadeira'])){
    $Questao = $_POST['questao'];
    echo $ConteudoPerguta = 'conteudo_pergunta'.$Questao;
    ?>
    <!--Modal para atualizar a pergunta e a resposta certa-->
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">
                        Resposta Certa Atualizada com sucesso
                    </h4>
                </div>
                <div class="modal-body">
                    <div class="col-md-12 text-center">
                        <h2><?php echo "<b>Questão alterada:</b> " . $Questao; ?></h2>
                    </div>
                    <div class="col-md-12 text-justify">
                      <?php
                      echo "<br><b>Conteudo da pergunta:</b> " . $ConteudoPerguta;
    ...
    <?php
}elseif($_POST['atualizarRespostasErrada']){
    ?>
    <!--Modal para atualizar as respostas erradas-->
